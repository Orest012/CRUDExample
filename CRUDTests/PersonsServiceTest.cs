...
namespace CRUDTests
{
    public class PersonsServiceTest
    {
        ...
        //{
        //    _personService = new PersonsService(new PersonDbContext(new DbContextOptionsBuilder<PersonDbContext>().Options));
        ...
        //    //Act
        //   // List<PersonResponse> persons_list_from_sort = _personService.GetSortedPerson(allPersons, nameof(Person.PersonName), SortOrderOptions.DESC);
